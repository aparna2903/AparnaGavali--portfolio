...
export const navMenu = ["Home", "Work","Experience","Education", "Skills", "About", "Contact"];
...
export const skillsData = [
  ...
  // },
  {
    icon: FaCode,
    title: "Deployment",
    technologies: ["Netlify", "Git", "Github", "Vercel","Render"],
  },
  {
    icon: FaMobile,
    title: "Mobile",
...
export const projectData = [
  ...
  description: "An intelligent travel companion web application that generates personalized itineraries, curates destination highlights, and provides a seamless planning experience for travelers.",
  image: "/project-images/trip.jpg",
  tech: ["JavaScript", "TailwindCSS", "ReactJS", "Vite", "AI API","nodejs"],
  projectLink: "",
  liveDemo: "",
},
{
  title: "Braghu Technology",
  description: "Dynamic web application highlights core strengths in custom web development, modern frontend frameworks, and user-centric software design.",
